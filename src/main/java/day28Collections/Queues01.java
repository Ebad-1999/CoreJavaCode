...
example for FIFO think about a warehouse application the products which produce first it sho
uld be sold out first.
Queue is need constructor but it is interface so it will use likedList or priorityQueue as constructor
When you linkedList as constructor, elements will be in insertion order but if it use
priorityQueue as constructor elements order will be according to some rules.
...
All Queues except the Dequeues supports insertion and removal at the tail and head of the queue respectively.
The Dequeues support element insertion and removal at both ends.
...
peek(): It is used to reach the next element in the queue.
    ...
    public static void main(String[] args) {
        ...
        String el1 = wareHouse.poll();//Retrieves and removes the head of
        ...
        String el2 = wareHouse.peek(); //Retrieves, but does not remove,
