...
public class VarArgs01 {
    public static void main(String[] args) {
         ...
         */
        /*
        Int Question1 ==> Can I use another regular parameter after varargs? ==> "No. Because "varargs" cannot be typed more than once.                             inside method parenthesis also if typed; second parameter will make java reach out the limit of varargs and it will give error.
