package day34_LambdaFPIntStringAndPoja;
...
public class CoursesPojo {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(checkAvgScoresToBeGreaterThanGivenNumber(coursesList, 90));
        System.out.println(checkIfAnyEleCourseNameContainsGivenWord(coursesList, "English"));
        System.out.println(getCourseNameWhoseAvgIsTheHighest(coursesList));//Turkish Night
        System.out.println(sortCourseWithAvgScoreInAscendingOrderSkipTheElementAccToGivenNum(coursesList, 2));
    ...
    //2) Create a method to check if at least one of the courses names contains given word.

    public static boolean checkIfAnyEleCourseNameContainsGivenWord(List<Courses> list, String word){
    ...
    //4)Sort the list elements according to the average score in ascending order and skip the element according to the given number
