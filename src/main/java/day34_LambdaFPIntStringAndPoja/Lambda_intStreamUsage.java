...
public class Lambda_intStreamUsage {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(findSumOfDigitsForTheIntegersInTheGivenRange(23, 32));//68
        System.out.println(findSumOfDigitsForTheIntegersInTheGivenRange01(32, 23));//68
   ...
   // IntStream: It is an artificial list  when we don't have a ready  list we can use
    ...
    public static int findSumOfDigitsForTheIntegersInTheGivenRange(int a, int b){
        return IntStream.rangeClosed(a, b).map(UtilsClass::getSumOfDigits).sum();
    }

      //If the first number greater than 2nd what will we do
    public static int findSumOfDigitsForTheIntegersInTheGivenRange01(int a, int b){
